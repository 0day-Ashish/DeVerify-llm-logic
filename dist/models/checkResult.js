...
const CheckResultSchema = new mongoose_1.Schema({
    ...
    timeline: { type: mongoose_1.Schema.Types.Mixed },
    normalizedTimeline: { type: mongoose_1.Schema.Types.Mixed },
    repos: { type: mongoose_1.Schema.Types.Mixed, default: [] },
    count: { type: Number, default: 0 }
}, { timestamps: true });
exports.CheckResult = mongoose_1.default.models.CheckResult || mongoose_1.default.model('CheckResult', CheckResultSchema);
exports.default = exports.CheckResult;
