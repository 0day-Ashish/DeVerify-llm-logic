...
const SubmissionSchema = new mongoose_1.Schema({
    ...
    github: { type: mongoose_1.Schema.Types.Mixed },
    signals: { type: mongoose_1.Schema.Types.Mixed },
    mintEvidence: { type: mongoose_1.Schema.Types.Mixed },
    llm: { type: mongoose_1.Schema.Types.Mixed },
    score: { type: Number },
    explanation: { type: String },
    flags: { type: [String], default: [] },
    ipfsProof: { type: mongoose_1.Schema.Types.Mixed }
}, { timestamps: true });
